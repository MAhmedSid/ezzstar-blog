...
const BlogCard = () => {
  return <div className="flex flex-col max-w-[500px] lp:max-w-[800px] lcd:max-w-[1000px] gap-y-2">
    <div className="w-full flex items-center justify-center">
          <video src={'/giflike.webm'} muted autoPlay loop className="h-full w-full rounded-xl object-fill"></video>
    </div>
    <h3>Final Fantasy XIV&apos;s Stormblood expansion free for a limited time, starting today</h3>
