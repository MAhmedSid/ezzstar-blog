    ...
    <DropdownMenu onOpenChange={toggleMenu}>
      ...
      <DropdownMenuContent>
        <div className=" bg-gradient-to-b from-pri_yellow  to-pri_blue p-[2px]">
          <div className="flex flex-col items-center justify-center rounded-md bg-[#0b0b0b] bg-opacity-90 text-white drop-shadow-lg  child-hover:text-pri_yellow ">
            <DropdownMenuItem>
              <Link
                prefetch
                href={"/#t"}
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent>
                    <div className="w-full bg-gradient-to-b from-pri_yellow  to-pri_blue p-[2px]">
                      <div className="flex flex-col items-center justify-center gap-y-4 rounded-md bg-[#0b0b0b] py-2  text-white  ">
                        <Link
                          prefetch
