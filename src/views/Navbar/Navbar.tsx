...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 z-50 flex w-full items-center justify-between gap-y-2 bg-[#0b0b0b] bg-opacity-70 px-6 py-4 font-medium text-white backdrop-blur-md tablet:justify-center tablet:gap-x-10  lp:px-24 lp:text-lg lcd:gap-x-24">
          ...
          <Popover>
            ...
            <PopoverContent>
              <div className=" rounded-md bg-gradient-to-b from-pri_yellow  to-pri_blue p-[2px]">
                <div className="flex flex-col items-center justify-center gap-y-3 rounded-md bg-[#0b0b0b] py-2  text-white  ">
                  <Link
                    prefetch
